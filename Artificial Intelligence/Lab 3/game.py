...
# @version Regis Clouard - Jul 21, 2012
#
...
class GameStateData:
    ...
    def __init__( self, prevState = None ):
        ...
        if prevState != None:
            ...
            self.killedGhosts = prevState.killedGhosts
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        self.score = 0
        self.scoreChange = 0
        self.killedGhosts = 0  # TODO
        self.killedGhostsChange = 0  # TODO
        self.agentStates = []
        numGhosts = 0
