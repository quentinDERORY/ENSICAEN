...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ColorWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 32, 11)
    },
    "ColorWidget\0colorChanged\0\0r\0g\0b\0"
    "changeColor\0"
};
...
void ColorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->colorChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (ColorWidget::*_t)(int , int , int );
...
const QMetaObject ColorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ColorWidget.data,
      qt_meta_data_ColorWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorWidget.stringdata))
...
// SIGNAL 0
void ColorWidget::colorChanged(int _t1, int _t2, int _t3)
{
